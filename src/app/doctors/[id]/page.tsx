    ...
    return (
        <div className="pt-32 container mx-auto px-4">
                ...
                <div className="w-full lg:w-3/5">
                    ...
                    <div className="border-t border-b border-gray-400 py-5 my-5">
                        <div className="flex w-full justify-between gap-4 py-1">
                            <p className="w-1/2 text-lg font-semibold text-gray-800">Experience</p>
                            <p className="w-1/2 text-gray-500 text-lg font-semibold">5 years</p>
                        </div>
                        <div className="flex w-full justify-between gap-4 py-1">
                            <p className="w-1/2 text-lg font-semibold text-gray-800">Qualifications</p>
                            <p className="w-1/2 text-gray-500 text-lg font-semibold">DO, MPH</p>
                        </div>
                        <div className="flex w-full justify-between gap-4 py-1">
                            <p className="w-1/2 text-lg font-semibold text-gray-800">Working hours</p>
                            <p className="w-1/2 text-gray-500 text-lg font-semibold">7 Hours</p>
                        </div>
                        <div className="flex w-full justify-between gap-4 py-1">
                            <p className="w-1/2 text-lg font-semibold text-gray-800">Location</p>
                            <p className="w-1/2 text-gray-500 text-lg font-semibold">45 Elm Avenue, New York, NY 10001</p>
                        </div>
                    </div>
            ...
            <div className="py-8 max-w-4xl mx-auto">
                <div className="py-4">
                    <h2 className="text-gray-800 text-3xl font-bold py-1">About:</h2>
                ...
                <div className="py-4">
                    <h2 className="text-gray-800 text-3xl font-bold py-1">Experience:</h2>
                    ...
                    <p className="text-gray-500 text-lg font-semibold">Dr. Bennett’s extensive experience in both clinical and cosmetic dermatology allows her to offer a wide range of treatments, from managing chronic skin conditions to performing advanced cosmetic procedures.</p>
                </div>
                <div className="py-4">
                    <h2 className="text-gray-800 text-3xl font-bold py-1">Specialities & Info:</h2>
                    ...
                    <p className="text-gray-500 text-lg font-semibold">Dr. Bennett’s expertise in skin cancer detection and treatment is another key aspect of her practice, where she emphasizes the importance of early detection and prevention.</p>
                </div>
            </div>
        </div>
    );
