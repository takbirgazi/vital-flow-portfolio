    ...
    return (
        <div className="pt-32 container mx-auto max-w-[1200px] pb-10 px-4">
            <div className="flex flex-col justify-center items-center mb-5">
                ...
                <h2 className="text-4xl font-semibold text-center max-w-[550px] py-5">Personalized solutions for better oral health</h2>
            </div>
            ...
            <div className="flex flex-col justify-center items-center my-5 mt-12">
                ...
                <h2 className="text-4xl font-semibold text-center max-w-[550px] py-5">What our satisfied and happy clients have to say</h2>
            </div>
