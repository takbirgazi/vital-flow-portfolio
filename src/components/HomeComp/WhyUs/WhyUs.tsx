    ...
    return (
        <div data-aos="zoom-in-up" className="flex flex-col lg:flex-row gap-4 justify-between my-5 pb-16">
            <div className="w-full lg:w-1/2">
                ...
                <h2 className="text-xl lg:text-4xl font-bold max-w-[450px] py-5">Why choose VitalFlow for your healthcare?</h2>
            ...
            <div className="w-full lg:w-1/2 relative min-h-96">
                ...
                <div className="border absolute lg:-bottom-10 lg:-left-16 bottom-0 left-auto bg-white p-4 rounded-2xl w-60 lg:w-80">
                    <div className="py-4">
